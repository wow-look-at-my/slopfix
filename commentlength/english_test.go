...
// Every entry in english.xml carries a test attribute, and each has to fire
// through the repair. Without this an entry that stopped matching -- a typo, a
// phrase the boundary rule rejects, a rewrite shadowed by a drop -- would sit
// in the table looking enforced while doing nothing.
...
// shape alone is what the table does.
